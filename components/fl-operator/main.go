...
import (
	...
	"github.com/katulu-io/fl-suite/fl-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5688c9fc.katulu.io",
	})
	if err != nil {
	...
	if err = (&controllers.FlOperatorReconciler{
	...
	if err = (&controllers.FlEdgeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "FlEdge")
		os.Exit(1)
	}
